...
<table width="100%">
    <tr>
        <td width="5%"></td>
        <td width="70%"><p class="FontGrandeGrassetto">Campagne chiuse a cui ti sei iscritto:</p></td>
        <td width="25%"></td>
    </tr>
    ...
    <tr>
        ...
        <table id="userCampaignsTable" class="display" cellspacing="2px" width="100%" align="center">
            ...
            <tbody>
            <%
                    ArrayList<Campagna> array = (ArrayList<Campagna>) session.getAttribute("Closed");
                    int i=0;
                    if(array!=null){
